...
import { Attachment, Prisma } from "@repo/database";
...
export class AttachmentRepository {
    ...
    // Update
    async updateAttachmemt(path: string, input: Prisma.AttachmentUpdateInput) {
        return await this.prisma.getTransaction().attachment.update({
            where: {
                path,
            },
            data: input,
